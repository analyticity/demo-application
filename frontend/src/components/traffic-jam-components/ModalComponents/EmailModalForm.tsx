/*
	...
	file: EmailModalForm.tsx
*/

import backendApi from "@/utils/traffic-jam-utils/api";
    ...
    >
      ...
      >
        ...
        <Form.Item
          ...
          label={t("app.subject")}
          rules={[
            { required: true, message: t("app.subjectHint"), whitespace: true },
          ]}
        >
          <Input />
        </Form.Item>
        <Form.Item
          name="body"
          label={t("app.body")}
          rules={[{ required: true, message: t("app.bodyHint") }]}
        >
          <Input.TextArea
            showCount
            maxLength={1000}
