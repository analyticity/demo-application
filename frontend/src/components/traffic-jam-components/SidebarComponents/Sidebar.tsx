...
const Sidebar = ({
  ...
  return (
    <div style={{ height: "100%" }}>
        ...
        {showMarkers && (
          ...
          >
            <Tooltip placement="right" title={t("JAM")}>
              <Checkbox
                onClick={() =>
                  updateAlerts("JAM", trafficCheck, setTrafficCheck)
                }
                checked={trafficCheck}
              >
                <TrafficJamIcon />
              </Checkbox>
            </Tooltip>
            <Tooltip placement="right" title={t("ACCIDENT")}>
              <Checkbox
                onChange={() =>
                  updateAlerts("ACCIDENT", accident, setTrafficAccident)
                }
                checked={accident}
              >
                <CarCrashIcon />
            ...
            <Tooltip placement="right" title={t("HAZARD")}>
              <Checkbox
                onChange={() =>
                  updateAlerts("HAZARD", hazard, setTrafficHazard)
                }
                checked={hazard}
              >
                <WarningSmallIcon />
            ...
            <Tooltip placement="right" title={t("ROAD_CLOSED")}>
              <Checkbox
                onChange={() =>
                  updateAlerts("ROAD_CLOSED", roadClosed, setRoadClosed)
                }
                checked={roadClosed}
              >
                <RoadClosedIcon />
      ...
      <PlotDrawer
        open={openDrawerPlot}
        onCloseDrawer={() => setOpenDrawerPlot(false)}
        loading={loading}
      />
      <StatsDrawer
        open={openDrawer}
