...
export const FILTER_DEFAULT_VALUE: FilterContext = {
  filterDefaultValue: {
    ...
    fromDate: dayjs('2025-01-01').format('YYYY-MM-DD'), 
    toDate: dayjs('2025-01-31').format('YYYY-MM-DD'), 
    streets: [],
  },
  filter: null,
  setNewFilter: () => {},
...
export const filterContext =
  React.createContext<FilterContext>(FILTER_DEFAULT_VALUE);
...
export const streetContext = React.createContext<StreetContext>(
  STREET_CONTEXT_DEFAULT_VALUE,
);
